...
//		String outputDir = "C://Users/VULCAN/Desktop/new";
		// 表名, 注意大小写
		String[] tableNames = new String[]{"sys_auth","sys_role","sys_role_auth","sys_user","sys_user_role"};
		// 数据库地址
		String url = "jdbc:mysql://192.168.206.131:3306/springsecuritydemo?useUnicode=true&characterEncoding=utf8";
		// 用户名
		String userName = "root";
		// 密码
		String password = "root";
		// 父包路径
		String parentPackage = "com.yzh";
		// 需要去掉的表名前缀
		String prefixTable = "sys_";
		// 设置项目名
		String ProjectName = "";
		
		generate(outputDir, tableNames, url, userName, password, parentPackage, prefixTable,ProjectName);
	}
	...
	public static void generate(String outputDir, String[] tableNames, String url, String userName,
			String password, String parentPackage, String prefixTable,String projectName) {
		// ===============  全局配置  ==================
